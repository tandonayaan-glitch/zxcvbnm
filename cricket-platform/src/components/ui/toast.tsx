        ...
        <div className="fixed bottom-4 right-4 z-[100] flex w-80 flex-col gap-2">
          {toasts.map((t) => (
            <div
              key={t.id}
              className={cn(
                'animate-fade-in flex items-center gap-2.5 rounded-lg border bg-white px-3.5 py-3 shadow-lg',
            ...
            >
              ...
              {t.action && (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md bg-ink-900 px-2 py-1 text-xs font-semibold text-white hover:bg-ink-700"
                >
